        ...
        EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                try
                {
                    ...
                    //URL url = new URL("http://www.reuters.com/article/us-china-steel-overcapacity-idUSKCN0XI05O");
                    ...
                    //browser.setLocation("list:" + localpath.substring(7) + "/test/list_reuters.txt");
